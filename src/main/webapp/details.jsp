...
<html>
    <head>
        ...
        <script type="text/javascript">
            function selflog_show(id) {
                ...
                J.dialog.get({id:'haoyue_creat',title:'购物成功',width:600,
                height:400,link:'<%=path%>/servlet/CartServlet?id='+id+'&num='+
                        num+'&action=add',cover:true});
            }
            function add() {
    ...
    <body>
        <h1>商品详情</h1>
        <a href="index1.jsp">首页</a>>><a href="index1.jsp">商品列表</a>
        <hr>
        <center>
